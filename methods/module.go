...
const (
	ModuleExploits           string = "module.exploits"
	ModuleEvasion            string = "module.evasion"
	ModuleAuxiliary          string = "module.auxiliary"
	ModulePayloads           string = "module.payloads"
	ModuleEncoders           string = "module.encoders"
